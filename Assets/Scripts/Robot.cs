...
public class Robot : MonoBehaviour
{
    ...
    public delegate void OnStartCountingDelegtae();
    public OnStartCountingDelegtae OnStartCounting;

    public delegate void OnStopCountingDelegtae();
    public OnStopCountingDelegtae OnStopCounting;
